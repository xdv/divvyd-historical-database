...
var importer = require('./divvy-importer');
...
var Validator = function() {
  ...
  function checkNextLedger() {
    ...
    function (err, ledger) {
      ...
      try {
        hash = divvyAPI.computeLedgerHash(convertLedger(ledger));
  ...
  function notify(ledger_index, message) {
    ...
    if (!notifications[ledger_index]) {
      ...
      var params = {
        from: 'Storm Import Validator <storm-import-validator@xdv.io>',
        to: to,
        ...
        html: "The validation process encountered an unexpected error: <br /><br />\n" +
          ...
          'https://data-staging.xdv.io/v2/ledgers/' + ledger_index + ' <br />\n' +
          'https://xdv.io/build/divvy-info-tool/#' + ledger_index
      };
